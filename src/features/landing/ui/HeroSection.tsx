...
import logoLexa from "@/shared/assets/logo-lexa.png";
            ...
            <div className="grid items-center gap-16 lg:grid-cols-2 w-full">
                ...
                >
                    ...
                    <div className="mt-12 flex items-center gap-4">
                        <Link href="/sign-up">
                            <Button size="lg" className="btn-glow rounded-full px-10 text-base shadow-xl shadow-primary/15 gap-2">
                                Começar Agora
                                <ArrowRight className="h-4 w-4" />
                            </Button>
                        </Link>
                        <a href="#funcionalidades">
                            <Button variant="outline" size="lg" className="rounded-full px-8 text-base border-border/60 hover:bg-muted/50">
                                Saiba Mais
                            </Button>
                        </a>
                    </div>
