...
import { isHappeningNow, getDurationLabel, getCategoryConfig } from "../../utils/helpers";
...
export function TimelineEvent({ event, isLast, onNavigate }: TimelineEventProps) {
    ...
    const duration = event.end_time ? getDurationLabel(event.start_time, event.end_time) : "Dia Todo";
