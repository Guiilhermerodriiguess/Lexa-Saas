  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
        className="text-[#1B2A4A] dark:text-[#E5E2DB]"
      />
      {/* Golden circle at apex */}
      <circle cx="32" cy="10" r="4" fill="#C5A55A" />
      {/* Left scale pan (Gold) */}
      <ellipse cx="20" cy="48" rx="8" ry="3" fill="none" stroke="#C5A55A" strokeWidth="2" />
      {/* Right scale pan (Gold) */}
      <ellipse cx="44" cy="48" rx="8" ry="3" fill="none" stroke="#C5A55A" strokeWidth="2" />
      {/* Crossbar (Gold) */}
      <line x1="20" y1="42" x2="44" y2="42" stroke="#C5A55A" strokeWidth="2" />
    </svg>
  );
}
